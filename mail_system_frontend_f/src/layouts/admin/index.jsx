...
import EditHostel from "../../views/admin/hostels/components/Edit"
...
export default function Admin(props) {
  ...
  const getActiveRoute = (routes) => {
    ...
    else if (window.location.pathname.includes("hostel/edit")) {
      setCurrentRoute("Edit Hostel");
    }
  ...
  const getRoutes = (routes) => {
    ...
    newRoutes.push(<Route path={`/scheduleMail/:hostel_id/:recipients?`} element={<Mail />} />)
    ...
    newRoutes.push(<Route path={`/hostel/edit/:id`} element={<EditHostel reqType="put" />} />)
